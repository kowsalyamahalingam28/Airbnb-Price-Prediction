...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/kowsalyamahalingam28/Airbnb-Price-Prediction.git
     ```
...
- If you encounter any issues during the installation process, Contact me at ```kowsalyamahalingam2004@gmail.com```
